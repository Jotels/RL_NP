...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--mode',
                        ...
                        choices=['train', 'eval'],
                        default='eval')
    parser.add_argument('--savedir',help='directory for saving figure',type=str,default='plots')
...
def main():
    ...
    fig.savefig(os.path.join(args.savedir, 'average_return'+ strftime("%d%m%y%:%H:%M", localtime()) + '.pdf'))
