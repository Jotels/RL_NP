...
# The below function helps to determine the position of the atom apparently
def position_atom_helper(
    ...
    focus = positions[focus] # Chooses what atom is the focus atom according to how the model uses an internal
                             # representation of distances (we reference distances to the focal atom)

    # Get a list of positions in sorted ascending order according to distance from the focal atom
